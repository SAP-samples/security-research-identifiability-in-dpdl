...
np.savez_compressed(path.join(save_filepath, f"unbounded_original_data_set_ham_size_{SIZE_D}.npz"), lookup=X[:SIZE_D])
np.savez_compressed(path.join(save_filepath, f"unbounded_alt_data_set_ham_size_{SIZE_D}.npz"), lookup=alt_set)